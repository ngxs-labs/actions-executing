    ...
    describe('Multiple Actions', () => {
      ...
      describe('async', () => {
        it('should be executing between dispatch and complete ', fakeAsync(() => {
          ...
          tick(1);
          expect(actionStatus).toEqual([null, { [AsyncAction1.type]: 1 }, null, { [AsyncAction2.type]: 1 }, null]);
        }));
        ...
        it('should be executing between dispatch and error', fakeAsync(() => {
          ...
          tick(1);
          expect(actionStatus).toEqual([null, { [AsyncAction1.type]: 1 }, null, { [AsyncErrorAction1.type]: 1 }, null]);
        }));
        ...
        describe('nested actions 2', () => {
          it('should be executing on nested actions (scenario 1)', fakeAsync(() => {
            ...
            store.select(actionsExecuting([NestedAsyncAction4, NestedAsyncAction5])).subscribe((_actionsExecuting) => {
